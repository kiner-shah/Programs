	...
	public static void main(String args[]) throws IOException {	
        ...
        try {
			...
			Runnable periodicTask = new Runnable() {
    			public void run() {
    				try {
    					String msgs[] = stub.getMessages("Client3");
    					for(String s : msgs) { 
            ...
            while(true) {
            	...
            	switch(c) {
            		case 1: String message = stub.joinGroup("Client3"); 
            				System.out.println(message);
            		break;
            		case 2: String message2 = stub.leaveGroup("Client3");
            		...
            		case 3: //System.out.println("Enter receiver's name: ");
            				...
            				boolean status = stub.sendMessage(msg, "Client3");
