...
public class GCClient1 {
	...
	String host = (args.length < 1) ? null : args[0];
        try {
    		...
    		public void run() {
                    try {
    			String msgs[] = stub.getMessages("Client1");
    			for(String s : msgs) { 
            ...
            while(true) {
            	...
            	switch(c) {
            		case 1: String message = stub.joinGroup("Client1"); 
            			System.out.println(message);
            		break;
            		case 2: String message2 = stub.leaveGroup("Client1");
            		...
            		case 3: //System.out.println("Enter receiver's name: ");
            			...
            			boolean status = stub.sendMessage(msg, "Client1");
