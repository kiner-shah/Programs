...
public class MEClient1 extends Thread {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Running Client1");
        s1 = new Socket("localhost", 3434);
        Socket sss1 = ss.accept(); if(sss1.getInetAddress().isReachable(30000)) System.out.println("Server connected to client 2");
            ...
            public void run() {
                try {
                    ...
                    if(n == 1) {
                        ...
                        if(ts < 8) {
                            w.write("OK"); requestQ.add(temp[0] + "," + temp[1]);
                        }
                        else {
                            w.write("WAIT"); requestQ.add(temp[0] + "," + temp[1]);
                        }
                    }
                    else {
                        PrintWriter w = new PrintWriter(sss2.getOutputStream(), true);
        ...
        w1.println("1,8"); w2.println("1,8"); System.out.println("Sent requests to: " + s1.getInetAddress() + "(" + s1.getPort() + "), " + s2.getInetAddress() + "(" + s2.getPort() + ")");
        t1.start(); //t2.start();
        ...
        Thread receiveResponse = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    String str2 = r2.readLine(); //System.out.println(str1 + " " + str2);
                    if(str1.equals("OK") && str2.equals("OK")) {
                        ...
                        if(str1.equals("OK")) System.out.println("RECEIVED OK FROM CLIENT 2");
